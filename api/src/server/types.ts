...
export interface AlertKeysNode {
    ...
    cl_balance_amount: string,
    cl_balance_amount_increase: string,
    ...
    cosmos_node_cometbft_rpc_url_invalid: string,
    cosmos_node_prometheus_is_down: string,
    cosmos_node_cosmos_rest_is_down: string,
    cosmos_node_cometbft_rpc_is_down: string,
    cosmos_node_no_synced_cosmos_rest_source: string,
    cosmos_node_no_synced_cometbft_rpc_source: string,
    cosmos_node_cosmos_rest_data_not_obtained: string,
    cosmos_node_cometbft_rpc_data_not_obtained: string,
