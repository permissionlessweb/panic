...
const cosmosThresholdAlerts = {
  byId: {
    ...
    15: {
      name: 'Cannot access cometbft rpc for Validator.',
      identifier: 'cannot_access_cometbft_rpc_validator',
      description: 'The Cometbft RPC for a validator has not been accessible for some time.',
      adornment: '%',
      adornment_time: 'Seconds',
      parent_id: '',
      warning: {
    ...
    16: {
      name: 'Cannot access cometbft rpc for Node.',
      identifier: 'cannot_access_cometbft_rpc_node',
      description: 'The Cometbft RPC for a node has not been accessible for a some time.',
      adornment: '%',
      adornment_time: 'Seconds',
      parent_id: '',
      warning: {
