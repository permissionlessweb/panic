...
class CosmosTestNodes:
    def __init__(self) -> None:
        self._archive_validator = CosmosNodeConfig(
            ...
            True, 'cosmos_rest_url_1', True, 'cometbft_rpc_url_1', True, True,
        ...
        self._archive_non_validator = CosmosNodeConfig(
            ...
            True, 'cosmos_rest_url_2', True, 'cometbft_rpc_url_2', False,
        ...
        self._pruned_validator = CosmosNodeConfig(
            ...
            True, 'cosmos_rest_url_3', True, 'cometbft_rpc_url_3', True,
        ...
        self._pruned_non_validator = CosmosNodeConfig(
            ...
            True, 'cosmos_rest_url_4', True, 'cometbft_rpc_url_4', False,
    ...
    def create_custom_node(
        ...
        :param monitor_cometbft_rpc: Whether to monitor cometbft or not
        :param cometbft_rpc_url: The cometbft rpc url
